...
export const home = {
    pl:{
        ...
        seo:{
            description:'Witaj na stronie głównej serwisu RadWEB. Znajdziesz tutaj sporo informacji nt. programowania jak i historii. Dowiesz się również co zrealizowałem i co oferuję. Zapraszam!',
            title:`RadWEB - Tworzenie, pozycjonowanie stron internetowych, Śrem`
        },
        about:{
            button:'Przeczytaj',
    ...
    pt:{
        ...
        seo:{
            description:'Bem-vindo à página principal do RadWEB. Aqui você encontrará muitas informações sobre programação e história. Você também aprenderá o que percebi e o que ofereço. Bem-vindo!',
            title:`RadWEB - Criação, otimização e posicionamento de sites`
        },
        about:{
            button:'Leia',
    ...
    fr:{
        ...
        seo:{
            description:`Bienvenue sur la page principale de RadWEB. Vous y trouverez de nombreuses informations sur la programmation et l'histoire. Vous apprendrez également ce que j'ai réalisé et ce que je propose. Accueillir!`,
            title:`RadWEB - Création, optimisation et positionnement de sites web`
        },
        about:{
    ...
    en:{
        ...
        seo:{
            description:'Welcome to the main page of RadWEB. Here you will find a lot of information about programming and history. You will also learn what I have realized and what I offer. Welcome!',
            title:`RadWEB - Creation, optimization and positioning of websites`
        },
        about:{
            button:'Read on',
    ...
    es:{
        ...
        seo:{
            description:'Bienvenido a la página principal de RadWEB. Aquí encontrarás mucha información sobre programación e historia. También aprenderás lo que he realizado y lo que ofrezco. ¡Bienvenidos!',
            title:`RadWEB - Creación, optimización y posicionamiento de sitios web`
        },
        about:{
    ...
    de:{
        ...
        seo:{
            description:'Willkommen auf der Hauptseite von RadWEB. Hier finden Sie viele Informationen zur Programmierung und Geschichte. Außerdem erfahren Sie, was ich realisiert habe und was ich anbiete. Herzlich willkommen!',
            title:`RadWEB - Erstellung, Optimierung und Positionierung von Websites`
        },
        about:{
            button:'Weiter lesen',
